...
export async function dashboardsAction(params: DeployCommandOptions, options: ConfirmActionOptions): Promise<void> {
  console.log(OutputTools.formatTitle('Directus CLI - Deploy Dashboards'))
  console.log()
    ...
    const { confirm } = await inquirer.prompt<{ confirm: boolean }>([
      {
        type: 'confirm',
        name: 'confirm',
        message: '¿Desplegar los Dashboards?',
        default: false,
      },
    ])
