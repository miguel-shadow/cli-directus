...
export async function schemasAction(params: DeployCommandOptions, options: ConfirmActionOptions): Promise<void> {
  console.log(OutputTools.formatTitle('Directus CLI - Deploy Schemas'))
  console.log()
